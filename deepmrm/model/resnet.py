...
def conv2x3(in_planes: int, out_planes: int, stride: int = 1, groups: int = 1, dilation: int = 1) -> nn.Conv2d:
    """1x3 convolution with padding"""
    return nn.Conv2d(
        in_planes,
        out_planes,
...
class ResNet1x3(ResNet):
    def __init__(self, layers=[2, 2, 2, 2], block=BasicBlock1x3, inplanes=64, conv1_height=1):
